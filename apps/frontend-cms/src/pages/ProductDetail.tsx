        ...
        <div className="lg:col-span-2 space-y-8">
          <Card className="border-slate-800/50 bg-slate-900/40 backdrop-blur-xl overflow-hidden group">
            <CardHeader className="border-b border-slate-800/50 pb-6 relative">
              ...
              <CardDescription>
                Comprehensive identification and pricing parameters.
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-8 space-y-8">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="p-4 rounded-2xl bg-slate-800/30 border border-slate-700/50 flex items-end gap-3 h-[76px]">
                      ...
                      <span className="text-xs text-slate-500 font-medium pb-1.5 uppercase tracking-wider">
                        Units available
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-4 rounded-2xl bg-slate-800/30 border border-slate-700/50 flex items-center justify-between">
                      ...
                      <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-slate-900 border border-slate-700 text-slate-500">
                        STABLE
                      </span>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-300 leading-relaxed bg-slate-800/20 p-6 rounded-2xl border border-slate-800/50 italic">
                  "
                  {product.description ||
                    'This product does not have a narrative description defined in the catalog.'}
                  "
                </p>
              </div>
            </CardContent>
          ...
          <Card className="border-slate-800/50 bg-slate-900/40 backdrop-blur-xl">
            <CardHeader>
              ...
              <CardDescription>
                Temporal tracking and registration records.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-800/20 border border-slate-800/50">
                <div className="flex items-center space-x-3">
                  <ShieldCheck
                    size={20}
                    className={
                      product.stock > 0 ? 'text-green-500' : 'text-amber-500'
                    }
                  />
                ...
                <span
                  className={`text-xs font-bold px-3 py-1 rounded-full ${product.stock > 0 ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-amber-500/10 text-amber-500 border border-amber-500/20'}`}
                >
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-primary-500/10 to-purple-500/10 border border-white/5 space-y-4">
                ...
                <p className="text-xs text-slate-400 leading-relaxed font-medium">
                  This unit is registered within the Global Distribution
                  Network. Inventory levels are dynamic across all connected
                  consumer endpoints.
                </p>
              </div>
            </CardContent>
